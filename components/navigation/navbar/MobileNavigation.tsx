   ...
   return (
      <Sheet>
         ...
         >
            ...
            <Link href="/" className="flex items-center gap-1 px-5 py-6">
               <Image
            ...
            <div className="scrollbar-hide flex h-[calc(100vh-80px)] flex-col justify-between overflow-y-auto">
               <SheetClose asChild>
                  <section className="flex h-full flex-col gap-6 pt-6 p-4">
